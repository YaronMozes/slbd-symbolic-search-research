...
\begin{enumerate}\setlength{\itemsep}{1pt}
    ...
    \item \textbf{Cross-Year Duplicate Leakage:} 322 of the 1,847 evaluated IPC instances are byte-identical to an instance in another domain (155 groups), so domain-wise cross-validation trains and tests on the same tasks; deduplication is a prerequisite for any learned-selector claim on this suite.
\end{enumerate}
